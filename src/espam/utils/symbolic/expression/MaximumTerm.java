 ...
 *  
 *  
 *    MaximumTerm = sign * numerator/denominator * DIV( linear expression, divider )
 *  
 *  
 * </pre>
 * 
 ...
 * @version $Id: MaximumTerm.java,v 1.1 2007/12/07 22:06:51 stefanov Exp $
 * @see LinTerm
 */

public class MaximumTerm extends LinTerm {
    ...
    /**
     * Constructor that creates a MaximumTerm with a given linear expression and
     ...
     *            Description of the Parameter
     */
    public MaximumTerm(Expression expressionOne, Expression expressionTwo) {
        super();
    ...
    /**
     * Clone the MaximumTerm.
     * 
     * @return a new instance of the MaximumTerm. / FIXME need more....
     */
    public Object clone() {
        MaximumTerm newobj = new MaximumTerm();
    ...
    public Expression substituteExpression(String index, Expression expression) {
        throw new Error(
                        "Substitution by Expression not implemeted in MaximumTerm");
    }
    ...
    /**
     * Return a description of the MaximumTerm.
     * 
     * @return a description of the MaximumTerm.
     */
    public String toString() {
        String ln = "";
        ln += "max(" + _expressionOne.toString() + ","
