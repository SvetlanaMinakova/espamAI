...
/**
 * This class represents a Floor term. A Floor Term is equal to a Term except
 * that is describes the Floor function instead of a variable or number. The
 * format of a Floor Term is:
 * <p>
 * 
 * <pre>
 * 
 * 
 * 
 *    FloorTerm = sign * numerator/denominator * Floor( linear expression )
 * 
 * 
 * 
 * </pre>
 ...
 * <p>
 * 
 * The floor function rounds a linear expression to the nearest integer towards
 * minus infinity. The result is an integer. The linear expression will
 * typically contain fractional numbers of type numerator/denominator.
 * 
 * @author Bart Kienhuis, Todor Stefanov
 * @version $Id: FloorTerm.java,v 1.1 2007/12/07 22:06:50 stefanov Exp $
 */

public class FloorTerm extends LinTerm {
    ...
    /**
     * Constructor to create a FloorTerm with a specific linear expression. It
     ...
     * 
     * @param expression
     *            The expression of the Floor term.
     */
    public FloorTerm(Expression expression) {
        super();
        _expression = expression;
        
        // Get a unique identifier
        String name = "f" + _number++;
        setName(name);
    }
     ...
     * Clone the FloorTerm.
     * 
     * @return a new instance of the FloorTerm.
     */
    public Object clone() {
        FloorTerm newobj = new FloorTerm();
    ...
    /**
     * Get the linear expression of the FloorTerm.
     * 
    ...
    /**
     * Check whether this Term equals a given Term. A FloorTerm is considered
     * equal when it is of the same type and the unqiue names given to the
     * FloorTerms are equal .
     * 
     * @param term
    ...
    public Expression substituteExpression(String index, Expression expression) {
        throw new Error(
                        "Substitution by Expression not implemeted in FloorTerm");
    }
    ...
    /**
     * Return a description of the FloorTerm.
     * 
     * @return a description of the FloorTerm.
     */
    public String toString() {
        ...
        if (getDenominator() == 1) {
            if (getNumerator() == 1) {
                ln += "floor(" + _expression.toString() + ")";
            } else {
                ln += getNumerator() + "*floor(" + _expression.toString() + ")";
            }
        } else {
            ln += getNumerator() + "/" + getDenominator() + "*floor("
    ...
    /**
     * Set the linear expression of the FloorTerm.
     * 
     * @param expression
