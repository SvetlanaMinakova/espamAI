...
public class CPPSDFGVisitor extends CSDFGraphVisitor{
     ...
     * @param y SDF Node
     */
    private void _writeMain(CSDFNode y) {
     ...
     * @param node SDF Node
     */
    private void _processReading(CSDFNode node){
       _printStream.println("");
      ...
      * @param node SDF Node
     */
    private void _processExecution(CSDFNode node){
    ...
    private void _processWriting(CSDFNode node){
       _printStream.println("");
     ...
     */
    private void _definePhasesLimitation(CSDFPort port, boolean isGroupLeader) {
     ...
     */
    private void _processEndLimitations(Vector<IndexPair> rates, String portName){
     ...
     * @param portName port name
     */
    private void _processStartLimitations(Vector<IndexPair> shifts, String portName){
        if(shifts==null)
            return;
     ...
     /**
     * Write include directives and namespace definition
     */
    /**
     ...
     */
    private void _writeCommonCppBeginning(String className){
    ...
    private void _writeAdditionalLibraries(){ }

    /**
     * Write constructor and destructor .cpp definitions
     * @param className name of the .cpp class
     */
    private void  _writeCppConstructorAndDestructor(String className, String baseClassName){
