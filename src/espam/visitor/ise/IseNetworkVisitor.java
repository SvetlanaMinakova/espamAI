 ...
 * @version $Id: IseNetworkVisitor.java,v 1.1 2009/09/24 12:46:19 sven Exp $
 */
...
public class IseNetworkVisitor extends PlatformVisitor {
  ...
  public void visitComponent(Platform x) {
    try {
      ...
      _iseScriptPS.println("project set family Virtex2P");
      _iseScriptPS.println("project set device XC2VP30");
      _iseScriptPS.println("project set package FF896");
      _iseScriptPS.println("project set speed -7");
...
//           create the subdirectories
    ...
    if(_adgInPorts.size() == 0){
      ...
      while(i.hasNext()){
        ...
        while (k.hasNext()) {
          ...
          // Signals
          _siglistS += "  signal s_" + in.getName() + "_Rd    : std_logic;\n";
          _siglistS += "  signal s_" + in.getName() + "_Din   : std_logic_vector(QUANT-1 downto 0);\n";
          _siglistS += "  signal s_" + in.getName() + "_Exist : std_logic;\n";
          _siglistS += "  signal s_" + in.getName() + "_CLK   : std_logic;\n";
          _siglistS += "  signal s_" + in.getName() + "_CTRL  : std_logic;\n";
        }
      }
    }
  ...
  private void _writeComponentInst() {
    _modinstS += "  -- Component instantiation of node " + _adgNode.getName() + "\n";
