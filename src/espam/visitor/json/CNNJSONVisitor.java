...
public class CNNJSONVisitor extends CNNGraphVisitor {
    ...
    public static void callVisitor(Network dnn, String dir){
           ...
           try {
            ...
            CNNJSONVisitor cnnvisitor = new CNNJSONVisitor(printStream);
    ...
    /**
     * Constructor for the CNNJSONVisitor object
     * @param  printStream work I/O stream of the visitor
     */
    public CNNJSONVisitor(PrintStream printStream) {
    ...
    if(pads!=null){
        _printStream.print(",");
        _printStream.println(_prefix + "\"pads\": ");
        String jsonPads = _gson.toJson(pads);
        _printStream.print(jsonPads);
    }
    ...
    public void visitComponent(Connection x) {
        if(x instanceof Custom)
            ...
            String strComponent = _gson.toJson(x,x.getClass());
            _printStream.print(strComponent);
        }
    }
