...
File Summary
  ...
  - HDL source -
  /home/mohamed/workspace/codeplex/clock_muxing/pcores/perf_counter_v1_00_a/hdl/vhdl
  top level      : perf_counter.vhd

  - XPS interface -
  /home/mohamed/workspace/codeplex/clock_muxing/pcores/perf_counter_v1_00_a/data
  mpd            : perf_counter_v2_1_0.mpd
  pao            : perf_counter_v2_1_0.pao

  - Misc file -
  /home/mohamed/workspace/codeplex/clock_muxing/pcores/perf_counter_v1_00_a/devl
  help           : README.txt
  option         : ipwiz.opt
  log            : ipwiz.log
...
written into src/perf_counter.c in the Driver Directory.
...
implemented in hdl/vhdl/perf_counter.vhd in the Core Directory.
