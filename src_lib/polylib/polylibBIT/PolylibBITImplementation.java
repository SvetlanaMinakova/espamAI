...
public class PolylibBITImplementation implements PolylibInterface {
    ...
    public Polyhedron Constraints2Polyhedron(JMatrix m) {
        ...
        /*
         * if ( PolyLibBIT.isTrustedSolution() == false ) { // Format the
         * current time. SimpleDateFormat formatter = new
         * SimpleDateFormat("yyyy.MM.dd 'at' hh:mm:ss a zzz"); Date
         * currentTime_1 = new Date(); String dateString =
         * formatter.format(currentTime_1); OutputStream file = null; String
         * fileName = UserInterface.getInstance().getFileName(); String name =
         * "case_" + fileName + "_" + _case++ + ".txt"; try { file = new
         * FileOutputStream(name); } catch(Exception b) { b.printStackTrace(); }
         * PrintStream printStream = new PrintStream(file); System.out.println(" --
         * [DUMP DEGENERATED PROBLEM] -- "); printStream.println("# Degenerate
         * Problem Generated by Compaan"); printStream.println("# Copyright (c)
         * LIACS 2004"); printStream.println("# Problem: " + fileName);
         * printStream.println("# Date: " + dateString);
         * printStream.println(""); printStream.println(" " + m.getNbRows() + " " +
         * m.getNbColumns()); printStream.println(m.toFormat());
    ...
    public Enumeration PolyhedronEnumerate(Polyhedron d1, Polyhedron d2) {
         ...
         * LIACS 2004"); printStream.println("# Problem: " + fileName);
         * printStream.println("# Date: " + dateString);
         * printStream.println(""); JMatrix md1 =
         * PolyLibBIT.Polyhedron2Constraints(d1); printStream.println(" " +
         * md1.getNbRows() + " " + md1.getNbColumns());
         * printStream.println(md1.toFormat()); printStream.println(""); JMatrix
         * md2 = PolyLibBIT.Polyhedron2Constraints(d2); printStream.println(" " +
         * md2.getNbRows() + " " + md2.getNbColumns());
         * printStream.println(md2.toFormat()); System.out.println(" -- [DONE] --
         * "); }
         */
