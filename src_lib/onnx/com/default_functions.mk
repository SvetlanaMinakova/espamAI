# $Id: default_functions.mk,v 1.1 2007/12/07 22:06:44 stefanov Exp $
#
...
#include $(ROOT)/javaclasses.mk

# The default compile rule
.java.class:
	rm -f `basename $< .java`.class
	CLASSPATH="$(CLASSPATH)$(CLASSPATHSEPARATOR)$(AUXCLASSPATH)$(CLASSPATHSEPARATOR)$(JAVASCOPECLASSPATH)$(CLASSPATHSEPARATOR)$(COMPAAN)" $(JAVAC) $(JFLAGS) $<
...
javadoc: 
	...
	if [ ! -d ./doc/codeDoc ]; then mkdir -p ./doc/codeDoc; fi; \
		$(JAVADOC) -d ./doc/codeDoc -private -version -author -classpath . -sourcepath . $(JAVACLASSES) )
